...
/**
 * <p>A command line wrapper for the Parser for FOLDOC-like dictionaries</p>
 * <p>Description: Model Expansion and Creation Using Reverse Engineered Ontologies - tools for extracting an querying an ontology automatically generated from a dictionary of computer science, in order to generate and compare (user) models</p>
 * <p>Copyright: </p>
 * <p> </p>
 * @author Trent Apted
 * @version 0.4
...
<pre>
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            System.err.println("Usage: java ... Parse inputFile [options] outputFile\n" +
                               "Options:\n" +
                               "\t-l      : Allow Leaves\n" +
                               "\t-w      : Show warnings\n" +
                               "\t-s      : Show statistics\n" +
...
*/
    ...
    public static void showCStats(HashGraph g) {
        System.out.println("Graph Size: " + g.size());
        System.out.println("Graph Density: " + g.density());
        System.out.println("Using a 'C' value of: " + Parser.WEIGHT_C + ":");
        System.out.println("Average relationship weight is: " + g.averageWeights());
        System.out.println("Average of concepts' average peers is: " + g.avgavgPeers());
	}
}
