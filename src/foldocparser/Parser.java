...
public class Parser {
    ...
    /** Replace strings of non-alpha numeric characters in s with a single space */
    private String removeNonAlnum(String s) {
    ...
    protected boolean category(Token tok, Node child) {
        ...
        Link lnk = new Link(cat, child, tok.baseWeight(), tok); //should be 1 for category
